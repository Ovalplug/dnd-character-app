...
<script lang="ts" setup>
  ...
  const props = defineProps<{ playerOptions: PlayerOptions[] }>();
  const sorted = computed(() => [...props.playerOptions].sort((a, b) => a.name.localeCompare(b.name)));
  const selected = ref<PlayerOptions | null>(null);
</script>
