  ...
  <div class="combatant-selector">
    <div class="combatant-selector__container">
      ...
      <div class="combatant-selector__panel">
        ...
        <button class="combatant-selector__add-btn" @click="addToTeam('allies')" :disabled="!selectedMonster">
          Add to Allies
        </button>
      </div>
      ...
      <div class="combatant-selector__panel">
        ...
        <button class="combatant-selector__add-btn" @click="addToTeam('enemies')" :disabled="!selectedMonster">
          Add to Enemies
        </button>
      </div>
    </div>
