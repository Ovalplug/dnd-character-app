          ...
          <div class="encounter-setup__result-box">
            ...
            <div class="encounter-setup__result-stats">
              ...
              <div class="encounter-setup__stat">
                ...
                <span class="encounter-setup__stat-value">{{ lastResult.finalCombatants.length }}</span>
              </div>
            </div>
          </div>
        </div>
...
const tabs = ref<Array<'map' | 'teams' | 'settings' | 'results'>>(['map', 'teams', 'settings', 'results']);
  ...
  const config: SimulationConfig = {
    ...
    combatants: [
      ...alliesConfig.value.map(c => ({
        ...
        role: c.role,
        position: { x: Math.floor(Math.random() * mapConfig.value!.width), y: Math.floor(Math.random() * mapConfig.value!.height) } as any
      })),
    ...
    resourceMode: (simulationConfig.value.resourceMode || 'balanced') as 'low' | 'balanced' | 'max',
