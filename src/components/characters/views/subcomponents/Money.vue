        ...
        <div v-if="isOpen" class="money-body">
            <div class="money-section-header">
                <div>
                    ...
                    <p class="money-section-copy">Track your main funds and any extra pouches or party banks.</p>
                </div>
            ...
            <div class="editor-shell">
                ...
                <section class="editor-section">
                    <div class="editor-heading editor-heading--split">
                        ...
                        <button class="money-edit-button money-edit-button--soft" type="button" @click="addWallet">
                            Add wallet
                        </button>
                    </div>
                    ...
                    <div v-for="wallet in editState.wallets" :key="wallet.id" class="editor-wallet-card">
                        <div class="editor-wallet-top">
                            <label class="editor-field editor-field--name">
                                <span>Name</span>
                                <input :value="wallet.name" type="text" @input="updateWalletName(wallet.id, $event)" />
                            </label>
                        ...
                        <div class="editor-grid">
                              <label v-for="coin in EDITOR_COINS" :key="`${wallet.id}-${String(coin.key)}`" class="editor-field">
                                <span>{{ coin.label }}</span>
                                <input
                ...
                <div class="editor-actions">
                    <button class="money-edit-button money-edit-button--soft" type="button" @click="closeEditor">
                        Cancel
                    </button>
...
<script lang="ts" setup>
    ...
    async function saveMoney() {
        ...
        await store.updateCharacterMoney(props.characterId, cloneCurrency(editState.main), editState.wallets);
        closeEditor();
    }
</script>
