<template>
    <div class="container">
        <div style="margin-bottom: 1em;">
            ...
            <span v-for="lang in Array.from(granted)" :key="lang" style="margin-right: 0.5em;">{{ lang }}</span>
        </div>
        <div style="margin-bottom: 1em;">
                ...
                <tr v-for="lang in allLanguageKeys" :key="lang">
                    ...
                    <td>
                        <input
                            ...
                            :disabled="isGranted(lang) || (!selected.includes(lang) && selected.length >= maxSelectable) || !isSelectable(lang)"
...
const allLanguageKeys = [
    ...
    'sylvan', 'undercommon', 'thievesCant'
];

function parseCurrLanguages(curr: any[]): { granted: Set<string>, anyStandard: number, other: boolean } {
...
const { granted, anyStandard, other } = parseCurrLanguages(Array.isArray(currLanguagesRaw) ? currLanguagesRaw : [currLanguagesRaw]);
